...
public class ManualTestActivity extends Activity {
    ...
    private void enableSetup() {
        ...
        ComponentName componentName = new ComponentName("com.xos.wizard",
                "com.xos.wizard.ui.SetupWizardActivity");
        pm.setComponentEnabledSetting(componentName, PackageManager.COMPONENT_ENABLED_STATE_ENABLED,
                PackageManager.DONT_KILL_APP);
        componentName = new ComponentName("com.xos.wizard",
                "com.xos.wizard.setup.FinishSetupReceiver");
        pm.setComponentEnabledSetting(componentName, PackageManager.COMPONENT_ENABLED_STATE_ENABLED,
                PackageManager.DONT_KILL_APP);
        pm.clearApplicationUserData("com.xos.wizard", null);
        ActivityManager am = (ActivityManager) getSystemService(Activity.ACTIVITY_SERVICE);
        am.killBackgroundProcesses("com.xos.wizard");
        try {
